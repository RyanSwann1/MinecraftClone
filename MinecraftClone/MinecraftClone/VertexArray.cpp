...
void VertexArray::attachTransparentVBO()
{
	...
	assert(m_vertexBuffer.transparentPositionsID == Utilities::INVALID_OPENGL_ID);
	...
	assert(m_vertexBuffer.transparentTextCoordsID == Utilities::INVALID_OPENGL_ID);
	...
	assert(m_vertexBuffer.transparentIndiciesID == Utilities::INVALID_OPENGL_ID);
